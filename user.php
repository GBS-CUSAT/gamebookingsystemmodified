  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="uaboutus.html">About Us</a></li>
        <li><a href="ugallery.html">Gallery</a></li>
        <li><a href="ucontactus.html">Contact Us</a></li>
      </ul>    
...
<div class="col-sm-2 sidenav">
  <a href="ucircles.html"> <button class="btn btn-primary" style="width: 100%;">My Circle</button></a><br/><br/>
   
  
  <a href="uevents.html"> <button class="btn btn-primary" style="width: 100%;">Events</button></a><br/><br/>
  <a href="ubooking.html"> <button class="btn btn-primary" style="width: 100%;"> My Bookings</button></a><br/><br/>
  ...
  <a href=upeople.html> <button class="btn btn-primary" style="width: 100%;">People</button></a><br/><br/> 
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <a href="ubook.html"><img src="images/football.jpg" alt="Football"></a>
    ...
    <div class="item">
      <a href="ubook.html"><img src="images/cricket.jpg" alt="Cricket"></a>
      <div class="carousel-caption">
        <h3>Cricket</h3>
    ...
    <div class="item">
      <a href="ubook.html"><img src="images/table-tennis.jpg" alt="Table-Tennis"></a>
      <div class="carousel-caption">
        <h3>Table Tennis</h3>
